          ...
          <div className="flex flex-col justify-evenly sm:flex-row w-[95%] mx-auto mt-7 space-y-2">
            <div className="w-[90%] sm:w-[28%] min-h-[10rem] mx-auto sm:mx-0 bg-white dark:bg-black rounded-md">
              ...
              <div className="flex flex-row items-center font-bold mt-2 dark:text-white">
                <button><Link href={"/"} className="flex flex-row items-center">Visit Homepage <FaLongArrowAltRight fontSize={15} className="mt-1 ml-1"/></Link></button>
              </div></div>
            </div>
            <div className="w-[90%] sm:w-[28%] min-h-[10rem] mx-auto sm:mx-0 bg-white dark:bg-black rounded-md space-y-2">
              ...
              <div className="flex flex-row items-center font-bold mt-2 dark:text-white">
                <button><Link href={"/blog"} className="flex flex-row items-center">Explore Blogs <FaLongArrowAltRight fontSize={15} className="mt-1 ml-1"/></Link></button>
              </div></div>
            </div>
            <div className="w-[90%] sm:w-[28%] min-h-[10rem] mx-auto sm:mx-0 bg-white dark:bg-black rounded-md space-y-2">
              <div className="w-full h-full p-4 dark:text-white"><div>
              ...
              <div className="flex flex-row items-center font-bold mt-2 dark:text-white">
                <button><Link href={"/create/blog"} className="flex flex-row items-center">Start writing <FaLongArrowAltRight fontSize={15} className="mt-1 ml-1"/></Link></button>
              </div></div>
            </div>
          </div>
