...
import { Alert, Button, Snackbar, Modal, Box, ButtonGroup, AlertColor } from '@mui/material';
...
const CreateBlogPage: React.FC = () => {
    ...
    const {mutate: createBlogMutation} = useMutation({
      mutationFn: async (newBlog: NewBlogData) => {
    ...
    const [severityType, setseverityType] = useState<AlertColor>("info");
